...
- [ ] **4 — Lane stacking for overlapping event spans/cards** — When multiple events or uncertainty spans overlap horizontally, assign vertical lanes with peek spacing so each item stays readable and clickable.
