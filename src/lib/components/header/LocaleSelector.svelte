<script lang="ts">
import { currentLocale, getLocaleName } from "$lib/stores/localeStore"
...
<div class="relative" bind:this={dropdownRef}>
	...
	{#if isOpen}
		<div
			class="absolute right-0 mt-2 min-w-36 bg-surface border border-border rounded-md shadow-lg z-[9999]"
		>
			<div class="py-1">
